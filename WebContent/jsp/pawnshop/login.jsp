...
<!-- 							</div> -->
	...
	<div class="banner-top">
		<div class="container">
			<h3>登录</h3>
			<h4>
				<a href="${pageContext.request.contextPath }/jsp/pawnshop/index.jsp">首页</a><label>/</label>登录
			</h4>
			<div class="clearfix"></div>
		</div>
	</div>
	...
	<div class="login">
		...
		<div class="main-agileits">
				...
				<form action="#" method="post">
					<div class="key">
						<i class="fa fa-user" aria-hidden="true"></i> <input type="text"
							value="学号" name="u_id" onfocus="this.value = '';"
							onblur="if (this.value == '') {this.value = '学号';}" required="">
						<div class="clearfix"></div>
					</div>
					<div class="key">
						<i class="fa fa-lock" aria-hidden="true"></i> <input
							type="password" value="Password" name="u_pwd"
							onfocus="this.value = '';"
			...
			<div class="forg">
				<a href="#" class="forg-right">忘记密码?</a>
				<div class="clearfix"></div>
			</div>
		</div>
	</div>
