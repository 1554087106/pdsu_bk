...
<body class="bg-light">
	...
	<header class="sidenav" id="sidenav">
		...
		<nav class="sidenav__menu-container">
			<ul class="sidenav__menu" role="menubar">
				<li><a href="#" class="sidenav__menu-link"><i class="fa fa-user-o"></i>个人中心</a>
					<button class="sidenav__menu-toggle" aria-haspopup="true" aria-label="Open dropdown">
						<i class="ui-arrow-down"> </i>
					</button>
					<ul class="sidenav__menu-dropdown">
						<li><a href="single-post-gallery.html" class="sidenav__menu-link">密码管理&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
					</ul></li>

				<li><a href="#" class="sidenav__menu-link"><i class="fa fa-university"></i>我们的院系</a>
					<button class="sidenav__menu-toggle" aria-haspopup="true" aria-label="Open dropdown">
						<i class="ui-arrow-down"></i>
					</button>
					<ul class="sidenav__menu-dropdown">
						<li><a href="${pageContext.request.contextPath}/jsp/office/facultyintrohome.jsp" class="sidenav__menu-link"></i>院系首页&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
						<li><a href="${pageContext.request.contextPath}/jsp/office/teacherintroall.jsp" class="sidenav__menu-link">我的老师&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
						<li><a href="${pageContext.request.contextPath}/jsp/office/officeintroall.jsp" class="sidenav__menu-link"></i>办公分布&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
					</ul></li>
				<li><a href="#" class="sidenav__menu-link"><i class="fa fa-etsy"></i>我的餐厅</a>
					<button class="sidenav__menu-toggle" aria-haspopup="true" aria-label="Open dropdown">
						<i class="ui-arrow-down"></i>
					</button>
					<ul class="sidenav__menu-dropdown">
						<li><a href="${pageContext.request.contextPath}/jsp/restaurant/index.jsp" class="sidenav__menu-link">走进餐厅&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
						<li><a href="${pageContext.request.contextPath}/jsp/restaurant/menu.jsp" class="sidenav__menu-link">菜单&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
						<li><a href="${pageContext.request.contextPath}/jsp/restaurant/products.jsp" class="sidenav__menu-link">今日吃法&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
					</ul></li>
				<li><a href="#" class="sidenav__menu-link"><i class="fa fa-cc-visa"></i>平院当铺</a>
					<button class="sidenav__menu-toggle" aria-haspopup="true" aria-label="Open dropdown">
						<i class="ui-arrow-down"></i>
					</button>
					<ul class="sidenav__menu-dropdown">
						<li><a href="single-post-gallery.html" class="sidenav__menu-link">逛逛&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
						<li><a href="single-post.html" class="sidenav__menu-link">有意思&nbsp&nbsp<i class="fa fa-toggle-right"></i></a></li>
					</ul></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<form class="notice__search-form" action="${pageContext.request.contextPath}/listAllNotice.action" method="post">
					<input type="text" name="queryString" value="${queryString}" placeholder="请输入查询" class="nav__search-input">
			...
			<div class="col-md-4 text-right">
				<select style="width: 40%;" name="edu" id="edu">
					<option value="公示公告" selected="selected">外部公告</option>
					<option value="管理公告">管理公告</option>
				</select>
					...
					<c:if test="${pageInfo.list!=null}">
						<c:forEach items="${pageInfo.list}" var="notice">
							<tr>
								...
								<td><a href="${pageContext.request.contextPath}/findNoticeById2.action?noticeID=${notice.id}"><i class="fa fa-eye"></i></a> <shiro:hasPermission name="root:power">
										<a href="${pageContext.request.contextPath}/jsp/main/writernotice.jsp"><i class="fa fa-plus"></i></a>
									</shiro:hasPermission> <shiro:hasPermission name="root:power">
										<a href="${pageContext.request.contextPath}/findNoticeById.action?noticeID=${notice.id}"><i class="fa fa-edit"></i></a>
									</shiro:hasPermission> <shiro:hasPermission name="root:power">
										<a href="${pageContext.request.contextPath}/deleteNotice.action?noticeID=${notice.id}"><i class="fa fa-trash"></i></a>
		...
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
					...
					<c:if test="${pageInfo.pageNum != 1}">
						<li><a
							href="${pageContext.request.contextPath}/listAllNotice.action?pageNum=${pageInfo.pageNum-1}&queryString=${queryString}"
							aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
						</a></li>
					</c:if>
					...
					<c:forEach begin="1" end="${pageInfo.pages }" var="pageIndex">
						...
						<c:if test="${pageIndex != pageInfo.pageNum }">
							<li><a
								href="${pageContext.request.contextPath}/listAllNotice.action?pageNum=${pageIndex}&queryString=${queryString}">${pageIndex}</a>
							</li>
						</c:if>
					</c:forEach>
			...
			<%-- <ul class="pagination">
				<li><c:if test="${pageInfo.hasPreviousPage}">
						<a href="${pageContext.request.contextPath}/listAllNotice.action?pageNum=${pageInfo.pageNum-1}"> <span aria-hidden="true">«</span>
						</a>
					</c:if></li>
				<li><a href="${pageContext.request.contextPath}/listAllNotice.action?pageNum=1">首页</a></li>
				...
				<c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
					...
					<c:if test="${page_num != pageInfo.pageNum}">
						<li><a href="${pageContext.request.contextPath}/listAllNotice.action?pageNum=${page_num}">${page_num}</a></li>
					</c:if>
				</c:forEach>
				<li><a href="${pageContext.request.contextPath}/listAllNotice.action?pageNum=${pageInfo.pages}">尾页</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 order-lg-1 text-md-center">
					<span class="copyright"> &copy; 2018 PDSU-BK | Made by 平顶山学院-计算机学院-双创·向量 </span>
				</div>
			</div>
		</div>
	</div>
