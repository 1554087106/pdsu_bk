    ...
    var Skippr = (function () {
        ...
        Skippr.prototype.arrowBuild = function() {
            ...
            var _ = this,
                previous,
                next,
                startingPrevious = _.count, // what will be the first previous
											// slide?
                previousStyles = '';
        ...
        Skippr.prototype.navBuild = function() {
        	...
        	for (var i = 0; i < _.count; i++) { 
        		// cycle through slideshow divs and display correct number of
				// bubbles.
        		var insert;
        ...
        Skippr.prototype.autoPlayPause = function() {
            ...
            // Checks if this tab is not being viewed, and pauses autoPlay timer
			// if not.
 ...
 * 
 * @version 0.0.18 @docs http://velocityjs.org @license Copyright 2014 Julian
 *          Shapiro. MIT License: http://en.wikipedia.org/wiki/MIT_License
 */
