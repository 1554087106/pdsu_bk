					...
					<div class="col-lg-8">
						...
						<form id="contact-form" class="contact-form mt-30 mb-30" method="post" action="${pageContext.request.contextPath}/updateNotice.action" enctype="form-data">
							...
							<div class="contact-name">
								<label for="name">标题 </label> <input style="border-left-width: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-color: black" name="title" type="text" value="${noticeValue.title}">
							</div>
							<%
								SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
							%>
							<div class="contact-email">
								<label for="email">时间 </label> <input style="border-left-width: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-color: black" name="time" type="date" value=<%=sdf.format(new Date())%>>
							</div>
							...
							<div class="contact-message">
								...
								<textarea class="ckeditor" style="border-left-width: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-color: black" id="message" name="content" rows="7" required="required">${noticeValue.content}"</textarea>
