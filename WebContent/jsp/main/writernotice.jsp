...
<body class="bg-light">
			...
			<div class="col-lg-12 blog__content mb-30">
				<div class="row justify-content-md-center">
					<div class="col-lg-8">
						...
						<!-- Contact Form -->
						<form class="contact-form mt-30 mb-30" action="${pageContext.request.contextPath}/insertNotice.action" method="post" enctype="form-data">
							<div class="contact-name">
								<label>标题 </label> <input style="border-left-width: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-color: black" name="title" type="text">
							</div>
							<%
								SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
							%>
							<div class="contact-name">
								<label>时间 </label> <input style="border-left-width: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-color: black" name="time" type="date" value=<%=sdf.format(new Date())%>>
							</div>
							<div class="contact-name">
								<label>发布人 </label> <input style="border-left-width: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-color: black" name="publisher" type="text">
							</div>
							<div class="contact-name">
								<label>内容 </label>
								<textarea   class="ckeditor" style="border-left-width: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-color: black" name="content" rows="7"></textarea>
								<script type="text/javascript">
										CKEDITOR.replace('content');
								</script>
							</div>
							<br> <input type="submit" class="btn btn-lg btn-color btn-button" value="发布">
						</form>
					</div>
				</div>
			</div>
	...
	<script src="${pageContext.request.contextPath}/topcontroller/main/ckeditor/ckeditor.js"></script>
	<script src="${pageContext.request.contextPath}/topcontroller/main/ckeditor/config.js"></script>
</body>
