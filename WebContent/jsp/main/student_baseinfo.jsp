...
<body class="bg-light">
	...
	<div class="main-container container mt-40" id="main-container">
		<form class="form-inline" action="${pageContext.request.contextPath}/updateStudent.action" method="post">
			<fieldset>
				<div id="legend" class="">
				...
				<div class="control-group">
					...
					<div class="controls">
							<input type="text" class="input-xlarge" name="s_name" value="${student.s_name}">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="input-xlarge" name="s_uid" value="${student.s_uid}">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" placeholder="placeholder" class="input-xlarge" name="s_sex" value="${student.s_sex}">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" placeholder="placeholder" class="input-xlarge" name="s_tel" value="${student.s_tel}">
					</div>
				</div>
				<div class="control-group">
					<!-- Text input-->
					...
					<div class="controls">
						<input type="text" placeholder="placeholder" class="input-xlarge" name="s_wq" value="${student.s_wq}">
					</div>
				</div>
				<div class="control-group">
					<!-- Text input-->
					...
					<div class="controls">
						<input type="text" placeholder="placeholder" class="input-xlarge" name="s_email" value="${student.s_email}">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<!-- Text input-->
					<label class="control-label" for="input01"> <i class="fa fa-id-card">-</i> 班 级：
					</label>
					<div class="controls">
						<input type="text" placeholder="placeholder" class="input-xlarge" name="s_class" value="${student.s_class}">
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" placeholder="placeholder" class="input-xlarge" name="s_cid" value="${student.s_cid}">
					</div>
				</div>
